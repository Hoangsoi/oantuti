...
export const Header: React.FC<HeaderProps> = ({ user, onProfileClick, onTopupClick }) => {
  if (!user) return null;
      ...
      <div className="card-glass p-3 flex items-center justify-between border-amber-500/20 shadow-amber-500/5">
        ...
        >
          <div className="relative">
            ...
            />
            <div className="absolute -bottom-1 -right-1 bg-amber-500 rounded-full p-0.5 text-slate-950 font-black text-[9px] px-1 shadow">
              PRO
            </div>
          </div>
          <div>
        ...
        {/* Right: Coins, Rating & Streak badges */}
