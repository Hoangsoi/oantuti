...
const REALISTIC_MASTERS = [
  { tgId: -201, name: 'Hoàng Nam', username: 'hoangnam_pro', rating: 2850, wins: 342, losses: 118, avatar: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=150&auto=format&fit=crop&q=80' },
  { tgId: -202, name: 'Bảo Trâm', username: 'bao_tram99', rating: 2720, wins: 289, losses: 95, avatar: 'https://images.unsplash.com/photo-1517841905240-472988babdf9?w=150&auto=format&fit=crop&q=80' },
  ...
  { tgId: -207, name: 'Hải Đăng', username: 'haidang_9x', rating: 2110, wins: 142, losses: 55, avatar: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=150&auto=format&fit=crop&q=80' },
  ...
  { tgId: -211, name: 'Gia Huy', username: 'giahuy_hn', rating: 1640, wins: 85, losses: 32, avatar: 'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=150&auto=format&fit=crop&q=80' },
  { tgId: -212, name: 'Thùy Dương', username: 'thuyduong_00', rating: 1580, wins: 76, losses: 29, avatar: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=150&auto=format&fit=crop&q=80' },
  { tgId: -213, name: 'Đức Anh', username: 'ducanh_top', rating: 1520, wins: 69, losses: 26, avatar: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=150&auto=format&fit=crop&q=80' },
  { tgId: -214, name: 'Hương Giang', username: 'huonggiang_2k', rating: 1460, wins: 61, losses: 22, avatar: 'https://images.unsplash.com/photo-1524504388940-b1c1722653e1?w=150&auto=format&fit=crop&q=80' },
  { tgId: -215, name: 'Quốc Bảo', username: 'quocbao_solo', rating: 1410, wins: 54, losses: 19, avatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150&auto=format&fit=crop&q=80' },
];
      ...
      await query(
        `INSERT INTO users (telegram_id, first_name, username, photo_url, rating, wins, losses, total_matches, referral_code)
         ...
         SET first_name = EXCLUDED.first_name,
             ...
             rating = GREATEST(users.rating, EXCLUDED.rating),
             wins = GREATEST(users.wins, EXCLUDED.wins),
             losses = GREATEST(users.losses, EXCLUDED.losses),
             total_matches = GREATEST(users.total_matches, EXCLUDED.total_matches)`,
        [
          master.tgId,
          master.name,
          master.username,
