...
- Bot Telegram đưa bản chụp đầy đủ nơi nhận vào thông báo đơn rút. Frontend mở khóa Web Audio sau thao tác chạm thực tế và chỉ dừng nghe khi trình duyệt xác nhận âm thanh đã chạy, giúp hỗ trợ Safari/Chrome trên điện thoại.
...
Kết quả trên máy ngày 09/09/2026: 18 kiểm thử backend và 13 kiểm thử giao diện đạt; lint và build đạt. Npm audit của backend/frontend không còn cảnh báo sau khi cập nhật thư viện. Kiểm tra này không chứng minh toàn bộ hệ thống không có lỗ hổng và không thay thế kiểm tra môi trường triển khai.
