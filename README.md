...
- Mọi chế độ chơi với bot dùng tỷ lệ bot thắng do admin cấu hình (mặc định 70%); 0% luôn cho khách thắng và 100% luôn cho bot thắng. Tài khoản công ty thấy nước đối thủ ngay sau khi nước đó được khóa, không bị xử thua do hết thời gian và được chọn hoặc đổi nước trong 10 giây chờ mở kết quả. Phía khách luôn thấy trạng thái đã khóa trong giai đoạn này. Giao diện dùng nước cuối cùng được backend xác nhận để tính kết quả.
